...
class RequestWrapper {
    ...
    /**
     * Generate a PDF Layer Url (GET only). SYNC function.
     * 
     * @param {object} [options={}] 
     * @returns 
     * @memberof RequestWrapper
    ...
    generateUrl(options = {}) {
        ...
        const uri = options.api_url;
        delete options.api_url;
        options = _.omit(options, POST_PARAMS);
        return uri + '?' + querystring.stringify(options);
    }
